...
public class MazeBug extends Bug {
	...
	int []probability = new int[4]; // 0 for North, 1 for East, 2 for South, 3 for West
	...
	private Location findBestLocation(ArrayList<Location> temp) {
		...
		// Many Location to choose
			...
			Location []fourLocations = new Location[4];
			...
			for (int i = 0; i < temp.size(); i++) {
				...
				fourLocations[dir/90] = temp.get(i);
				// mark each direction
				switch (dir) {
		...
		System.out.print("Next: " + bestLocation);
		return bestLocation;
	}
	/**
