...
## Vi/Vim
&emsp;&emsp;大一的时候在上程序设计课程的时候就已经接触过Vim这款编辑器，它是一款Linux系统里自带的唯一文本编辑器，可以支持直接在命令行中编辑文本，但是它的界面相比起其他编辑器如sublime text或者Atom等在外观上会稍微差一些。个人平时用的比较多是windows，因此从方便性来说个人不是很喜欢使用Vim。
